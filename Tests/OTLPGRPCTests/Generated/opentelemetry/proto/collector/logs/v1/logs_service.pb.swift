...
struct Opentelemetry_Proto_Collector_Logs_V1_ExportLogsServiceRequest: Sendable {
  ...
  var resourceLogs: [OTLPCore.Opentelemetry_Proto_Logs_V1_ResourceLogs] = []
...
struct Opentelemetry_Proto_Collector_Logs_V1_ExportLogsServiceResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Opentelemetry_Proto_Collector_Logs_V1_ExportLogsPartialSuccess: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
