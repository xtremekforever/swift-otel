...
struct Opentelemetry_Proto_Collector_Trace_V1_ExportTraceServiceRequest: Sendable {
  ...
  var resourceSpans: [OTLPCore.Opentelemetry_Proto_Trace_V1_ResourceSpans] = []
...
struct Opentelemetry_Proto_Collector_Trace_V1_ExportTraceServiceResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Opentelemetry_Proto_Collector_Trace_V1_ExportTracePartialSuccess: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
