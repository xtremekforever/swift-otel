...
package struct Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsServiceRequest {
...
package struct Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsServiceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
package struct Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsPartialSuccess {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
