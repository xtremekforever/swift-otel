...
package struct Opentelemetry_Proto_Collector_Logs_V1_ExportLogsServiceRequest {
...
package struct Opentelemetry_Proto_Collector_Logs_V1_ExportLogsServiceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
package struct Opentelemetry_Proto_Collector_Logs_V1_ExportLogsPartialSuccess {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
