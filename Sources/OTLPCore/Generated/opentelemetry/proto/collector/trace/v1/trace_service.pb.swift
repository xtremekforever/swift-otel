...
package struct Opentelemetry_Proto_Collector_Trace_V1_ExportTraceServiceRequest {
...
package struct Opentelemetry_Proto_Collector_Trace_V1_ExportTraceServiceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
package struct Opentelemetry_Proto_Collector_Trace_V1_ExportTracePartialSuccess {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
